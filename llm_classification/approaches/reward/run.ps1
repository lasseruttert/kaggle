param(
    [switch]$SkipTrain,
    [string]$Message = "auto deploy reward $(Get-Date -Format 'yyyy-MM-dd HH:mm')"
)

$ErrorActionPreference = "Stop"
$root        = Resolve-Path "$PSScriptRoot/../.."
$datasetDir  = "$root/kaggle_dataset/reward-finetuned"
$kaggleId    = "lasseruttert/reward-inference"
